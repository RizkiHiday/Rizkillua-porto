...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    el => {
      ...
      const wantsResize = openedImageWidth !== undefined && openedImageHeight !== undefined && (openedImageWidth !== 'auto' || openedImageHeight !== 'auto');
      if (wantsResize && openedImageWidth !== 'auto' && openedImageHeight !== 'auto') {
        const onFirstEnd = ev => {
        ...
        const onFirstEnd = ev => {
          ...
          tempImg.onload = () => {
            ...
            const maxW = frameR.width * 1.2;
            const maxH = frameR.height * 1.2;
